        ...
        <div className="mt-6 grid grid-cols-2 gap-8">
          <div>
            ...
            <div className="mt-5 border-l-4 border-navy-500 bg-navy-50 p-4">
              ...
              <p className="mt-2 text-body text-neutral-700">The candidate track is consistent with the reconstructed source-region window across spatial and temporal factors, while remaining subject to synthetic-data limits.</p>
